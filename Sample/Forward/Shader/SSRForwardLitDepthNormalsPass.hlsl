#ifndef UNIVERSAL_SSR_FORWARD_LIT_DEPTH_NORMALS_PASS_INCLUDED
#define UNIVERSAL_SSR_FORWARD_LIT_DEPTH_NORMALS_PASS_INCLUDED
...
)
{
    ...
    Alpha(sampleVar.a, _BaseColor, _Cutoff);
        ...
        outNormalWS = half4(packedNormalWS, smoothness);                  // Store smoothness for Forward
    #else
        float2 uv = input.uv;
        ...
        outNormalWS = half4(NormalizeNormalPerPixel(normalWS), smoothness); // Store smoothness for Forward
    #endif
